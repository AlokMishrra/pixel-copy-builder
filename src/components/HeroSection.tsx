...
const HeroSection = () => {
  ...
  return (
    <section className="relative">
      <img 
        src="/lovable-uploads/9548370a-7e49-45f9-b100-0ddff731964d.png" 
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center space-y-6">
          <Button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 text-xl rounded-lg shadow-lg transform transition-transform hover:scale-105 animate-fade-in"
          >
            Register Now
          </Button>
        </div>
