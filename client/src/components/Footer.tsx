            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 rounded-xl relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-green-400 via-blue-500 via-purple-500 via-pink-500 to-orange-400 rounded-xl"></div>
                  <div className="absolute inset-0.5 bg-gray-900 rounded-lg flex items-center justify-center">
                    <span className="text-white font-bold text-lg bg-gradient-to-br from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">Z</span>
                  </div>
                  <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full"></div>
                  <div className="absolute top-2 -right-0.5 w-2 h-2 bg-yellow-400 rounded-full"></div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-12">
            ...
            >
              ...
              <div className="w-8 h-8 rounded-lg relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-green-400 via-blue-500 via-purple-500 via-pink-500 to-orange-400 rounded-lg"></div>
                <div className="absolute inset-0.5 bg-white rounded-md flex items-center justify-center">
                  <span className="text-black font-bold text-sm">Z</span>
                </div>
                <div className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-red-500 rounded-full"></div>
                <div className="absolute top-1 -right-0.5 w-1.5 h-1.5 bg-yellow-400 rounded-full"></div>
